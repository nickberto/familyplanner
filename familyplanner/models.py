...
class User(UserMixin, db.Model):
    ...
    # Relationships
    entries = db.relationship("Entry", backref="created_by", foreign_keys="Entry.created_by_user_id")
    entries_updated = db.relationship("Entry", backref="updated_by", foreign_keys="Entry.updated_by_user_id")
    recurring_templates = db.relationship("RecurringTaskTemplate", backref="created_by", foreign_keys="RecurringTaskTemplate.created_by_user_id")
    recurring_templates_updated = db.relationship("RecurringTaskTemplate", backref="updated_by", foreign_keys="RecurringTaskTemplate.updated_by_user_id")
...
class Entry(db.Model):
    ...
    ENTRY_TYPE_TASK = "task"
    ENTRY_TYPES = [ENTRY_TYPE_EVENT, ENTRY_TYPE_TASK]
